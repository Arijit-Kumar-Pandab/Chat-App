...
import com.app.chatapp.adapters.RecentConversationsAdapter;
import com.app.chatapp.databinding.ActivityMainBinding;
import com.app.chatapp.listeners.ConversionListener;
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if(documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (preferenceManager.getString(Constants.KEY_USER_ID).equals(senderId)) {
                        ...
                        chatMessage.conversationName = documentChange.getDocument().getString(Constants.KET_SENDER_NAME);
